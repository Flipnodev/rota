...
export default function EditProgramScreen() {
      ...
      [
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: async () => {
            ...
            if (result.success) {
              showAlert("Deleted", "The program has been deleted");
              router.replace("/programs");
            } else {
              showError("Error", result.error || "Could not delete the program");
            }
          },
        },
      ]
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.errorContainer}>
          <Text style={styles.errorTitle}>Could not load program</Text>
  ...
  const renderInfoStep = () => (
    ...
    >
      ...
      <Text style={styles.stepSubtitle}>
        Edit the program name and settings
      </Text>
      ...
      {/* Delete button at the bottom of info step */}
  ...
  const renderWorkoutsStep = () => (
    ...
    >
      ...
      <Text style={styles.stepSubtitle}>
        Edit workouts for each training day ({programDraft.daysPerWeek} days/week)
      </Text>
  ...
  const renderExercisesStep = () => (
    ...
    >
      ...
      <Text style={styles.stepSubtitle}>
        Edit exercises for each workout
      </Text>
